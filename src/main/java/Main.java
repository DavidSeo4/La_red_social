            ...
            switch (selectorMenu) {
                ...
                case 2:
                    ...
                    switch (tipo_post) {
                        case 1:
                            ...
                            Post post = new Post_texto(new Date(), new ArrayList<>(), "Texto", titulo, contenido, redSocial.getUserActivo());
                        ...
                        case 2:
                            ...
                            System.out.println("Escribe las dimensiones de la imagen. Ejemplo: 345x256");
                            String dimensiones = scanner_añadir_datos.nextLine();
                            Post post2 = new Post_imagen(new Date(), new ArrayList<>(), "Imagen", titulo2, dimensiones, redSocial.getUserActivo());
                        ...
                        case 3:
                            ...
                            System.out.println("Escribe la calidad del video. Ejemplo: 720p");
                            String calidad = scanner_añadir_datos.nextLine();
                            System.out.println("Escribe la duración del video en segundos");
                            int duracion = scanner_añadir_datos.nextInt();
                            Post post3 = new Post_video(new Date(), new ArrayList<>(), "Video", titulo3, calidad, duracion, redSocial.getUserActivo());
                ...
                case 3:
                    ...
                    if (redSocial.extraerUser(usuario).getListaPosts().isEmpty()) {
                        ...
                        //La fecha tambien se puede extrar con LocalDate.now()//
                ...
                case 6:
                    ...
                    if (user.equals(redSocial.extraerUser(userActivo))) {
                        ...
                        redSocial.getUserActivo().getListaSeguidos().remove(redSocial.extraerUser(user));
                    }
                    break;
                case 7:
                    //Eliminar un post//
                ...
                case 9:
                    ...
                    System.out.println("De que usuario quieres listar los posts? ");
                    String user_post = Input.string();
                    redSocial.mostrarUsers();
                    if (redSocial.extraerUser(user_post).getListaPosts().isEmpty()) {
                        System.out.println("No tienes ningún post que mostrar");
                    } else {
                        redSocial.mostrarPostsUser(redSocial.extraerUser(userActivo));
                    }
                    break;
                ...
                case 11:
                    ...
                    if (redSocial.extraerUser(userActivo).getListaPosts().isEmpty()) {
                        System.out.println("No tienes ningún post que mostrar, por lo tanto no tienes comentarios");
                    } else {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    System.out.println("De quien quieres ver el muro? ");
                    String user_muro = Input.string();
                    if (redSocial.getListaUsuarios().containsKey(user_muro)){
                        redSocial.mostrar_muro(redSocial.extraerUser(user_muro));
                    } else {
                        System.out.println("Ese usuario no consta en la base de datos. Escribe uno de los disponibles correctamente.");
                    }
